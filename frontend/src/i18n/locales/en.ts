export default {
  ...
  keys: {
    ...
    accelerationPolicyHint: 'Manage first-byte multi-request racing for this key. It only affects OpenAI request scheduling.',
    hedgeEnabled: 'Enable double/multi-send protection',
    hedgeHint: 'Launch the initial requests immediately; if no first byte arrives before the wait time, launch additional requests.',
    hedgeInitialParallelCount: 'Initial parallel requests',
    hedgeDelaySeconds: 'First-byte wait time (seconds)',
    hedgeDelayedParallelCount: 'Additional requests after timeout',
    hedgeMaxParallelCount: 'Maximum parallel requests',
    hedgeRouteStrategy: 'Second route strategy',
    hedgeSameAccount: 'Same-account multi-send protection',
  ...
  usage: {
    ...
    hedge: 'Hedge',
    hedgeDisabled: 'Disabled',
    hedgeAttempts: 'Attempts',
    hedgeWinner: 'Winner',
    hedgeCanceled: 'Canceled',
    hedgeErrors: 'Errors',
    hedgeAttemptStatus: 'Status',
    hedgeAttemptDuration: 'Duration',
    hedgeAttemptFirstToken: 'First byte',
    duration: 'Duration',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
