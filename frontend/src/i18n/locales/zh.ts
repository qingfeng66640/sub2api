export default {
  ...
  keys: {
    ...
    resetNow: '即将重置',
    accelerationPolicy: '加速策略',
    accelerationPolicyHint: '统一管理首字多路竞速保护，开启后只影响该密钥的 OpenAI 请求调度。',
    hedgeEnabled: '启用双发/多发保护',
    hedgeHint: '请求开始时立即并发初始请求数；若超过等待时间仍未收到首字，再追加请求。',
    hedgeInitialParallelCount: '初始并发请求数',
    hedgeDelaySeconds: '首字等待时间（秒）',
    hedgeDelayedParallelCount: '超时后追加请求数',
    hedgeMaxParallelCount: '最大并发请求数',
    hedgeRouteStrategy: '第二路策略',
    hedgeSameAccount: '同账号多发保护',
    expiration: '密钥有效期',
  ...
  usage: {
    ...
    hedgeCanceled: '取消',
    hedgeErrors: '错误',
    hedgeAttemptStatus: '状态',
    hedgeAttemptDuration: '耗时',
    hedgeAttemptFirstToken: '首字',
    duration: '耗时',
    time: '时间',
    ws: 'WS',
    stream: '流式',
